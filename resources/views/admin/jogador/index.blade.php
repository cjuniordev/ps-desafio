                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category">{{ __('Lista de todas as jogadores') }}</p>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Nome</h5>
                                <input type="text" id="detalhes-nome" name="detalhes-nome" class="form-control" readonly>
                            </div>

                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Idade</h5>
                                <input type="text" id="detalhes-idade" name="detalhes-idade" class="form-control"
                                       readonly>
                            </div>
                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Nacionalidade</h5>
                                <input type="text" id="detalhes-nacionalidade" name="detalhes-nacionalidade" class="form-control"
                                       readonly>
                            </div>
    ...
    <script>
        ...
        $('#modal-detalhes').on('show.bs.modal', function(event) {
            ...
            $.getJSON(url, (resposta) => {
                ...
                $("#detalhes-idade").val(resposta.idade)
                $("#detalhes-nacionalidade").val(resposta.nacionalidade_id)
