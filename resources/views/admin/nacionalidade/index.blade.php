@extends('layouts.app', ['activePage' => 'nacionalidade-management', 'titlePage' => __('Nacionalidade')])
    ...
    <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <a class="float-right" href="{{ route('nacionalidade.create') }}">
                                <button type="button" title="{{ __('Add Nacionalidade') }}" class="btn btn-primary add-button">
                                    <i class="material-icons">add_circle_outline</i>{{ __('Add Nacionalidade') }}
                                </button>
                            </a>
                            <h4 class="card-title ">{{ __('Nacionalidade') }}</h4>
                            <p class="card-category">{{ __('Lista de todas as nacionalidades') }}</p>
                        </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" title="{{ __('Visualizar') }}"
                                                        ...
                                                        data-id="{{ $nacionalidade->id }}" class="btn btn-danger">
        ...
        <div id="modal-excluir" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body" align="center">Tem certeza de que quer excluir essa nacionalidade?
                    </div>
        ...
        <div id="modal-detalhes" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Visualização da nacionalidade</h5>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Nome da nacionalidade</h5>
                                <input type="text" id="detalhes-nome" name="detalhes-nome" class="form-control" readonly>
                            </div>

                            <div class="form-group col-md-12 col-sm-12">
                                <h5 class="modal-title col-12 text-dark" id="serviceModalLabel">Sigla</h5>
                                <input type="text" id="detalhes-sigla" name="detalhes-sigla" class="form-control"
                                       readonly>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $('#modal-detalhes').on('show.bs.modal', function(event) {
            ...
            $.getJSON(url, (resposta) => {
                ...
                $("#detalhes-sigla").val(resposta.sigla)
            });
        })
